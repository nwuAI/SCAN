...
import surface_distance as surface_distance
...
def process_resampled_labels():
    ...
    labeldir = '/home/wy/data/datanii/malc/train/labelfine' #label directory for all nifty images
    savedir = '/home/wy/data/datanii/malc/train/labelcoarse' #directory to save numpy images
...
def convertToNifty(datadir, savedir):
    ...
    for datafile in datafiles:
        ...
        nib.save(img, os.path.join(savedir,datafile[:-8]+'.nii.gz'))
...
#        file_gt_npy[file_gt_npy==idx] = 0
    ...
    for idx in np.unique(file_gt_npy):
        ...
        average_surf_dist=surface_distance.compute_average_surface_distance(surface_distances_pred)
        dist_pred = surface_distance.compute_robust_hausdorff(surface_distances_pred, 95)
        dist_pred_lists.append(dist_pred)
        aver_surfdist_lists.append(average_surf_dist)
        dice=surface_distance.compute_dice_coefficient(temp_gt, temp_pred)
    ...
    print(file_name)
    print(np.mean(dist_pred_lists, axis=0))
    print(np.mean(aver_surfdist_lists, axis=0))
    # print(np.mean(dice_lists, axis=0))
    print("-----------------")
    sava_dir='/home/wy/data/save_model/denseformer/pwml/test3/metric'
    np.save(os.path.join(sava_dir,file_name[:-7]+'_hdpred.npy'), dist_pred_lists)
    np.save(os.path.join(sava_dir,file_name[:-7]+'_asdpred.npy'), aver_surfdist_lists)
...
def process_Hausdorff_distance():
    ...
    baseline_dir = None
    pred_dir = '/home/wy/data/save_model/denseformer/pwml/test3/pred'
    gt_dir = '/home/wy/data/datanii/pwml/test/label1' #gt label directory, double check the rotation matches with pred
    

    # subfiles = [name for name in os.listdir(gt_dir)] #init
    subfiles = [name for name in os.listdir(pred_dir)]
...
if __name__ == '__main__':
    ...
    # process_Hausdorff_distance()
    datadir='/home/wy/data/datanii/malc/train/labelcoarse'
    # # datadir='/home/wy/data/pwml/training-imagesnpy'
    # # datadir='/home/wy/data/dhcp/testing-labels-remapnpy'
    savedir='/home/wy/data/datanii/malc/train/labelcoarse2'
    # # savedir='/home/wy/data/datanii/pwml/train/image1'
    # # savedir='/home/wy/data/datanii/dhcp/test/label1'
    convertToNifty(datadir, savedir)
    #
    # npy_dir='/home/wy/data/save_model/denseformer/pwml/test3/metric/52_asdpred.npy'
    # datanpy = np.load(npy_dir)
    # npy_dir1 = '/home/wy/data/save_model/denseformer/pwml/test3/metric/52_hdpred.npy'
    # datanpy1 = np.load(npy_dir1)
    # print(datanpy)
